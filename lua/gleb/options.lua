...
local options = {
	...
	cmdheight = 0, -- render cmdline a the bottom (without bottom padding)
	completeopt = { "menuone", "noselect", "menu" }, -- mostly just for cmp
	conceallevel = 0, -- so that `` is visible in markdown files
	fileencoding = "utf-8", -- the encoding written to a file
	hlsearch = true, -- highlight all matches on previous search pattern
	ignorecase = true, -- ignore case in search patterns
	mouse = "", -- disabled: avoid accidental trackpad inserts/selects/scroll
	...
	scrolloff = 15, -- always keep N lines above and below cursor
	sidescrolloff = 8,
